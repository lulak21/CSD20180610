...
public class ProjetosDeVida extends FluentTest {
	...
	@Test
	public void simulacaoProjetoDeVida() throws InterruptedException {
		...
		await().atMost(2000).until("#txtValorTotalAcumulado").isPresent();
